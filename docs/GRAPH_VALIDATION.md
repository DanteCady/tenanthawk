...
| SP1 | `GET /reports/getSharePointSiteUsageDetail(period='D30')` | SharePoint v1 checks | **Pass (CSV)** | Storage, activity, file counts, owners; External Sharing column when present. |
